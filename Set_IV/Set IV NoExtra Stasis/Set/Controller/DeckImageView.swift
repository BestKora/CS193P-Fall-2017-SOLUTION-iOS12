...
class DeckImageView: UIImageView {
    ...
    private func centeredAttributedString(_ string: String,
        ...
        var font =
            UIFont.preferredFont(forTextStyle: .body).withSize(fontSize).bold()
    ...
    override func layoutSubviews() {
        ...
        deckNumberLabel.center = bounds.origin.offsetBy(dx: bounds.size.width/2,
   ...
   //     setNeedsDisplay()
    ...
    override func draw(_ rect: CGRect) {
        if let cardBackImage = UIImage(named: "Deal Deck",
